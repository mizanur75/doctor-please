...
@section('heading','Gallery Category')
@section('title',' Media > Gallery Category')
@section('content')
...
<div class="col-md-6">
  <div class="col-md-12 panel">
    ...
    <div class="col-md-12 panel-body padding-bottom30">
      {!!Form::open(['url'=>'gallery-category','method'=>'post', 'enctype'=>'multipart/form-data'])!!}
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-info"> Update Gallery category information</h4>
                </div>
                <div class="modal-body">
                {!!Form::open(['url'=>['gallery-category',$sItem->id],'method'=>'put', 'enctype'=>'multipart/form-data'])!!}
