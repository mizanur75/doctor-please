  ...
  <div class="col-md-12 panel">
    ...
    <div class="col-md-12 panel-body padding-bottom30">
      ...
      <div class="form-group">
        {{ Form::label('Testimonials-Title-bn', 'Testimonials Name (Bangla)') }}
      ...
      <div class="form-group">
        {{ Form::label('Testimonials-Title-bn', 'Testimonials Designation') }}
        {{ Form::text('txtDesignation',old("txtDesignation"),['class'=>'form-control','maxlength'=>'65','required'])}}
