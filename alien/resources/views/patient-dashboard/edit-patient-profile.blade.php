           ...
           <div class="col-md-12 box mar-top10 academic">
             ...
             <fieldset>
               ...
               <div class="row">
                 ...
                 <div class="col-sm-4">
                   {{ Form::text('txtGoogle',$sItem->google,['class'=>'form-control','maxlength'=>'69','placeholder' => 'Google Duo'])}}
                 ...
                 <div class="col-sm-4">
                   {{ Form::text('txtSkype',$sItem->skype,['class'=>'form-control','maxlength'=>'69','placeholder' => 'Skype ID'])}}
               ...
               <div class="row">
                 ...
                 <div class="col-sm-4">
                   {{ Form::text('txtMobile',$sItem->mobile,['class'=>'form-control','maxlength'=>'11','placeholder' => 'Mobile No'])}}
                 ...
                 <div class="col-sm-4">
                   {{ Form::text('txtIMO',$sItem->imo,['class'=>'form-control','maxlength'=>'11','placeholder' => 'IMO No'])}}
