...
@section('heading','Blog Category')
@section('title',' Blog Information > Blog Category')
@section('content')
...
<div class="col-md-6">
  <div class="col-md-12 panel">
    ...
    <div class="col-md-12 panel-body padding-bottom30">
      {!!Form::open(['url'=>'blog-category','method'=>'post', 'enctype'=>'multipart/form-data'])!!}
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-info"> Update blog category information</h4>
                </div>
                <div class="modal-body">
                {!!Form::open(['url'=>['blog-category',$sItem->id],'method'=>'put', 'enctype'=>'multipart/form-data'])!!}
