...
<html lang="en">
    <head>
        <title>Hello Doctor Login &amp; Register</title>
        <meta charset="utf-8">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Welcome to Hello Doctor</strong> Login &amp; Register</h1>
                        	...
                        	<div class="form-box">
	                        	<div class="form-top">
	                        		<div class="form-top-left">
	                            		...
	                            		<p>Enter your registered email and password to log on:</p>
	                        		</div>
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Sign up now</h3>
	                            		<p>Register For New Account It's Free!</p>
	                        		</div>
	                        		<div class="form-top-right">
        	...
        	<div class="container">
        		<div class="row">
        			...
        			<div class="col-sm-8 col-sm-offset-2">
        				...
        				<p>© {{date('Y')}} - hello-doctor.com.bd All Rights Reserved. Developed and maintenance by nanoworkerbd.com.</p>
        			</div>
